        ...
        <div class="col-12">
                  ...
                  <div class="col-12 delivery-info-descr">
                    <div class="row delivery-info-descr-body">
                      <div class="col-12 mb-5">
                        ...
                        <p>Доставка воды в Красное село и окрестные пункты. Заказать воду на дом и в офисы в Красное село можно по расписанию:</p>
                        <p>Вт, Ср, Пт с 10ч до 18ч</p>
          ...
          <section class="row mb-4">
            <div class="col-12">
              ...
              <div class="content px-lg-2 pt-2">
                <p>Оформить заказ на доставку воды в Красное село можно в нашем <a href="/catalog">каталоге</a> или по телефону <a href="tel:+78129477993">+7 (812) 947-79-93</a></p>
              </div>
            </div>
          </section>
          ...
          <section class="row mb-4" v-if="products">
            <div class="col-12">
              ...
              <div class="content px-lg-2 pt-2">
                <p>Цены на кулеры для воды, помпы для воды и прочее сопутствующее оборудование и сопутствующие товары с доставкой в Красное Село.</p>
                <div class="py-3 mb-3">
                  <CatalogCarousel
                    :gap="'20px'"
                    :activeQnt="4"
