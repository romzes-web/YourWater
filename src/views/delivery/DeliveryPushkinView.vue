        ...
        <div class="col-12">
                  ...
                  <div class="col-12 delivery-info-descr">
                    <div class="row delivery-info-descr-body">
                      <div class="col-12 mb-5">
                        <p>Доставка питьевой воды в пригороды СПб – Славянка, Пушкин, Коммунар, Павловск!</p>
                        <p>Доставка воды в Павловск, Пушкин, Коммунар и Славянку на дом и в офисы по расписанию:</p>
          ...
          <section class="row mb-4">
            <div class="col-12">
              ...
              <div class="content px-lg-2 pt-2">
                <p>Оформить заказ на доставку воды в Пушкин, Павловск, Коммунар и Славянку можно в <a href="/catalog">нашем каталоге</a> или по телефону <a href="tel:+78129477993">+7 (812) 947-79-93</a></p>
              </div>
            </div>
          </section>
          ...
          <section class="row mb-4" v-if="products">
            <div class="col-12">
              ...
              <div class="content px-lg-2 pt-2">
                <p>В компании «Ё-Water» вы можете осуществить заказ воды (Коммунар, Пушкин, Павловск, Славянка) и сопутствующие аксессуары.<br>Цены на кулеры для воды, помпы для воды и прочее сопутствующее оборудование и сопутствующие товары с доставкой в Пушкин, Павловск, Коммунар и Славянку.</p>
                <div class="py-3 mb-3">
                  <CatalogCarousel
                    :gap="'20px'"
                    :activeQnt="4"
